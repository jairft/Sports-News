package me.dio.sportsnews.data;

import androidx.room.Room;

import me.dio.sportsnews.App;
import me.dio.sportsnews.data.local.SoccerNewsDb;
import me.dio.sportsnews.data.remote.SoccerNewsApi;
...
public class SoccerNewsRepository {
    ...
    //region Constantes
    private static final String REMOTE_API_URL = "https://jairft.github.io/Sports-News-API/";
